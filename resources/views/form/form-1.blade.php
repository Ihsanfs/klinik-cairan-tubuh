                        ...
                        <div class="col-auto mt-4">
                            <h1 class="page-header-title">
                                ...
                                <a class="navbar-brand" href="#">
                                    <img style="margin-right: 0.75rem" src="{{ asset('images/logo.png') }}" height="20px;"
                                        class="d-inline d-md-none d-lg-none" alt="" />
                                    <img style="margin-right: 0.75rem" src="{{ asset('images/logo.png') }}" height="40rem;"
...
<div class="container-xl px-4 mt-n10">
    ...
    <div class="card" id="form-1">
        <div class="card-header border-bottom">
            <h3 class="text-center">DATA DEMOGRAFI PASIEN</h3>
            ...
            <div class="py-5 py-xl-10">
                <div class="row justify-content-center">
                    <div class="col-xxl-6 col-xl-8">
                        <h5 class="card-title mb-4">Masukan data diri kamu</h5>

                        <form method="POST"  action="{{route('store.diagnosa')}}" >
                            @method('post')
                            @csrf
                            <div class="mb-3">
                                <label class="small mb-1" for="nama">Nama / Inisial</label>
                                <input class="form-control mb-3" id="nama" name="nama" type="text"
                                    placeholder="Masukkan nama..." aria-label="default input example" required>
                            </div>
                            <div class="mb-3">
                                <label class="small mb-1" for="alamat">Alamat</label>
                                <input class="form-control mb-3" id="alamat" name="alamat" type="text"
                            ...
                            <div class="row gx-3">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" name="usia" id="usia" type="text"
                            ...
                            <div class="row gx-3">
                                ...
                                <div class="mb-3 col-md-6 d-none" id="fPekerjaan">
                                    <input class="mt-3 form-control" id="fekerjaan" type="text" name="pekerjaan"
                                        placeholder="Sebutkan disini ... " value="" required>
                                </div>
                            </div>
                            <div class="row gx-3">
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-check-inline mb-3">
                                        <input class="form-check-input" name="pendapatan" type="radio" id="pendapatan1"
                                            value="Dibawah UMR Rp2,238,094/Bulan" required>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="pendapatan" type="radio" id="pendapatan2"
                                            value="Diatas UMR Rp2,238,094/Bulan" required>
